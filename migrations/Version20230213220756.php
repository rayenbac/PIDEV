 ...
 */
final class Version20230213220756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mood (id INT AUTO_INCREMENT NOT NULL, mood_id INT NOT NULL, user_id INT NOT NULL, mood INT NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
